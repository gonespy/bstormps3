...
# History
In 2014 the Gamespy servers were shut down. Amongst the games that used these servers is Bulletstorm on the PlayStation 3 (PS3) console. The server shutdown rendered the "Anarchy" co-operative game mode unplayable. It also meant that the PlayStation trophies that involved this game mode were no longer obtainable.
...
* change your PS3 network settings to use your DNS server
...
I think it would be safest to just run your own Gonespy server within your own network.
