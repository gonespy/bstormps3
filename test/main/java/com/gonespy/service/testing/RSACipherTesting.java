...
public class RSACipherTesting {
    ...
    private static final String EXAMPLE_MOD = ("00df1e0a07074067271ff8853d03ab" +
            ...
            "ccb27854b899a5c1e7");
    private static final String EXAMPLE_PUBLIC_EXP = "10001";
    private static final String EXAMPLE_PRIVATE_EXP = ("00d68804ae435bba93951b19c9d408" +
    ...
    public static void eaEmuCheck() throws Exception {
    ...
    public static void atlasCheck() throws Exception {
    ...
    public static void atlasWithEaEmuSig() throws Exception {
        // gamespy ATLAS keys
        RSAPublicKeySpec pubKeySpec = new RSAPublicKeySpec(new BigInteger(CertificateUtils.WS_AUTHSERVICE_SIGNATURE_KEY, 16), new BigInteger(CertificateUtils.WS_AUTHSERVICE_SIGNATURE_EXP, 16)); // game client
    ...
    public static void exampleCheck() throws Exception {
